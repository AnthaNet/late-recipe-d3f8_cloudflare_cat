...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflarecatai
```

A live public deployment of this template is available at [https://cloudflarecatai.templates.workers.dev](https://cloudflarecatai.templates.workers.dev)
